...
//
//class SimpleUserService extends UserService[User] {
//  val logger = Logger("application.controllers.SimpleUserService")
//
...
//        val newUser = User(email = "email@gmail.com", fullname = "Daniel Beck", username = null, projects = null, main=null, identities = List())
//
